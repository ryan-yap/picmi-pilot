...
describe("Connection", function() {
	describe('constructor', function () {
		...
		it("should use gateway.sandbox.push.apple.com when NODE_ENV=production", function () {
		...
		it("should use gateway.sandbox.push.apple.com when production:true", function () {
			expect(Connection({production:true}).options.address).to.equal("gateway.sandbox.push.apple.com");
		});
		...
		describe("address is passed", function() {
			it("sets production to true when using production address", function() {
				expect(Connection({address: "gateway.sandbox.push.apple.com"}).options.production).to.be.true;
			});
